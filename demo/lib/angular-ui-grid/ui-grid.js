  ...
  return {
    initialize: function( baseOptions ){
      ...
      if (!baseOptions.showHeader) {
        ...
        baseOptions.headerRowHeight = typeof(baseOptions.headerRowHeight) !== "undefined" ? baseOptions.headerRowHeight : 60;
      }
       ...
       * @name rowHeight
       * @propertyOf ui.grid.class:GridOptions
       * @description The height of the row in pixels, defaults to 60
       *
       */
      baseOptions.rowHeight = baseOptions.rowHeight || 60;
    ...
    function ($q, $templateCache, uiGridSelectionConstants, gridUtil) {
      ...
      var service = {
        ...
        defaultGridOptions: function (gridOptions) {
           ...
           *  <br/>Defaults to 30px
           */
          gridOptions.selectionRowHeaderWidth = angular.isDefined(gridOptions.selectionRowHeaderWidth) ? gridOptions.selectionRowHeaderWidth : 60;
  ...
  function ($q, uiGridTreeBaseConstants, gridUtil, GridRow, gridClassFactory, i18nService, uiGridConstants, rowSorter) {
    ...
    var service = {
      ...
      defaultGridOptions: function (gridOptions) {
         ...
         *  <br/>Defaults to 60
         */
        gridOptions.treeRowHeaderBaseWidth = gridOptions.treeRowHeaderBaseWidth || 60;
